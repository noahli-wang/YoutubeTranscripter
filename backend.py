...
def extract(url):
    ...
    return combinedTranscript(fetched_transcript)
...
def combinedTranscript(fetched_transcript):#This function combines all the text snippets in one string
    ...
    for snippet in fetched_transcript:#Loop through each snippet in the fetched transcript#".
        snip = snippet.text.split()
        #Splits the text of each snippet into individual words. Splits at spaces.".text" is an object attribute of the snippet dictionary
